...
{
    let innerHTMLTabele = "<thead><tr><th>Name</th><th>SSN</th><th>Phone number</th><th>Username</th><th>Password</th><th>Email</th><th>Cronic patient</th><th>Disease</th><th>Delete</th></tr></thead><tbody>";
    nizPacijenata=[];
    listaPacijenata.pacijenti.forEach((pacijent) =>  { 
        nizPacijenata[pacijent.id]=pacijent.korisnickoIme;
        innerHTMLTabele += "<tr><td>"+ pacijent.ime + " "+ pacijent.prezime  
                ...
                +"<input type='checkbox' name='"+pacijent.id+"' value='"+pacijent.id+"'>  Check to delete</input></td></tr>";})
