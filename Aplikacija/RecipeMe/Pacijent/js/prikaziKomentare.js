...
fetch("../php/vratiKomentare.php?username="+name).then(response=>
{
    if(!response.ok)
...
function prikaziObavestenja(lista)
{
    ...
    if(lista.length==0)
    {
        kontenjerDiv.innerHTML="There is no any new comments...";
    }
    else{
        lista.reverse().forEach((obavestenje)=>
        {
            ...
            naslov.innerHTML=obavestenje.pacijent;
            ...
            telo.innerHTML=obavestenje.komentar;
